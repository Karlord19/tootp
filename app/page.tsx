	...
	return (
		<div style={{ padding: '20px' }}>
			...
			<div style={{ marginBottom: '20px' }}>
				...
				<ul style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', listStyleType: 'none', padding: 0, gap: '10px' }}>
					{users.map((user) => (
						<li key={user.username} style={{ boxSizing: 'border-box' }}>
							{user.username}
						</li>
					))}
				</ul>
